...
namespace MySql.Data.Types
{
  ...
  internal struct MySqlBinary : IMySqlValue
  {
    ...
    {
      var types = new string[] { "BLOB", "TINYBLOB", "MEDIUMBLOB", "LONGBLOB", "BINARY", "VARBINARY" };
      var dbtype = new MySqlDbType[] { MySqlDbType.Blob, 
                MySqlDbType.TinyBlob, MySqlDbType.MediumBlob, MySqlDbType.LongBlob, MySqlDbType.Binary, MySqlDbType.VarBinary };
      var sizes = new long[] { 65535L, 255L, 16777215L, 4294967295L, 255L, 65535L };
      var format = new string[] { null, null, null, null, "binary({0})", "varbinary({0})" };
      var parms = new string[] { null, null, null, null, "length", "length" };
