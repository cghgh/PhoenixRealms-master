...
namespace MySql.Data.Common
{
  ...
  internal class NamedPipeStream : Stream
  {
    ...
    void CancelIo()
    {
      var ok = NativeMethods.CancelIo(handle.DangerousGetHandle());
      if (!ok)
    ...
    public override int Read(byte[] buffer, int offset, int count)
    {
      ...
      var result = fileStream.BeginRead(buffer, offset, count, null, null);
    ...
    public override void Write(byte[] buffer, int offset, int count)
    {
      ...
      var result = fileStream.BeginWrite(buffer, offset, count, null, null);
      if (result.CompletedSynchronously)
      {
