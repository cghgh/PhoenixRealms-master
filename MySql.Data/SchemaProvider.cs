...
namespace MySql.Data.MySqlClient
{
  internal class SchemaProvider
  {
    ...
    public virtual DataTable GetSchema(string collection, String[] restrictions)
    {
      ...
      var dt = GetSchemaInternal(collection, restrictions);
    ...
    public virtual DataTable GetDatabases(string[] restrictions)
    {
      ...
      var table = new DataTable("Databases");
    ...
    {
      var sql = String.Format("SHOW FULL COLUMNS FROM `{0}`.`{1}`",
                     schema, tableName);
    ...
    public virtual DataTable GetIndexes(string[] restrictions)
    {
      ...
      var max = restrictions == null ? 4 : restrictions.Length;
    ...
    public virtual DataTable GetIndexColumns(string[] restrictions)
    {
      ...
      foreach (DataRow table in tables.Rows)
      {
        ...
        using (var reader = cmd.ExecuteReader())
        {
          while (reader.Read())
          {
            var key_name = GetString(reader, reader.GetOrdinal("KEY_NAME"));
            var col_name = GetString(reader, reader.GetOrdinal("COLUMN_NAME"));
    ...
    {
      var dt = new DataTable("Foreign Keys");
                       ...
                       string filterName, bool includeColumns)
    {
      ...
      var sql = string.Format("SHOW CREATE TABLE `{0}`.`{1}`",
    ...
    public virtual DataTable GetUsers(string[] restrictions)
    {
      ...
      var da = new MySqlDataAdapter(sb.ToString(), connection);
      var dt = new DataTable();
      da.Fill(dt);
      dt.TableName = "Users";
    ...
    {
      var dt = new DataTable("Procedures");
    ...
    private DataTable GetDataSourceInformation()
    {
...
#else
      var dt = new DataTable("DataSourceInformation");
      ...
      var ver = String.Format("{0:0}.{1:0}.{2:0}",
    ...
    {
      var dt = new DataTable("DataTypes");
    ...
    protected virtual DataTable GetRestrictions()
    {
      ...
      var dt = new DataTable("Restrictions");
      dt.Columns.Add(new DataColumn("CollectionName", typeof(string)));
    ...
    {
      var dt = new DataTable("ReservedWords");
    ...
    private void FindTables(DataTable schemaTable, string[] restrictions)
    {
      ...
      var table_type = restrictions[1].ToLower() == "information_schema"
                  ?
                "SYSTEM VIEW"
                  : "BASE TABLE";
    ...
    public virtual DataTable GetUDF(string[] restrictions)
    {
      ...
      var dt = new DataTable("User-defined Functions");
