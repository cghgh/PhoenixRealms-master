...
namespace MySql.Data.MySqlClient
{
  ...
  internal sealed class MySqlPromotableTransaction : IPromotableSinglePhaseNotification, ITransactionPromoter
  {
    ...
    {
      var valueName = Enum.GetName(
      typeof(IsolationLevel), baseTransaction.IsolationLevel);
      var dataLevel = (System.Data.IsolationLevel)Enum.Parse(
           typeof(System.Data.IsolationLevel), valueName);
      var simpleTransaction = connection.BeginTransaction(dataLevel);
