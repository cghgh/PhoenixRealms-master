...
namespace MySql.Data.MySqlClient
{
  ...
  internal class PreparableStatement : Statement
  {
    ...
    public virtual void Prepare()
    {
      ...
      string text;
      var parameter_names = PrepareCommandText(out text);
      ...
      // for the prepare
      for (var i = 0; i < parameter_names.Count; i++)
      {
        //paramList[i].ColumnName = (string) parameter_names[i];
        var parameterName = (string)parameter_names[i];
      ...
      foreach (var p in parametersToSend)
    ...
    public override void Execute()
    {
      ...
      for (var i = 0; i < parametersToSend.Count; i++)
      {
        var p = parametersToSend[i];
