...
namespace MySql.Data.MySqlClient
{
  ...
  internal class Driver : IDisposable
  {
    ...
    public virtual void Configure(MySqlConnection connection)
    {
      ...
      // want results in
      var charSetCmd = new MySqlCommand("SET character_set_results=NULL",
                        connection);
      charSetCmd.InternallyCreated = true;
      var clientCharSet = serverProps["character_set_client"];
      var connCharSet = serverProps["character_set_connection"];
      if ((clientCharSet != null && clientCharSet.ToString() != charSet) ||
        (connCharSet != null && connCharSet.ToString() != charSet))
      {
        var setNamesCmd = new MySqlCommand("SET NAMES " + charSet, connection);
    ...
    public virtual List<MySqlError> ReportWarnings(MySqlConnection connection)
    {
      ...
      var cmd = new MySqlCommand("SHOW WARNINGS", connection);
      ...
      var args = new MySqlInfoMessageEventArgs();
