    ...
    public sealed class MySqlConnection : DbConnection, ICloneable
    {
        ...
        public override void Open()
        {
            ...
            if (settings.AutoEnlist && Transaction.Current != null)
            {
                ...
                if (driver != null &&
                  ...
                  !driver.Settings.EquivalentTo(Settings)))
                    Throw(new NotSupportedException(Resources.MultipleConnectionsInTransactionNotSupported));
            }
#endif
            ...
            try
            {
                if (settings.Pooling)
                {
                    var pool = MySqlPoolManager.GetPool(settings);
        ...
        public void CancelQuery(int timeout)
        {
            ...
            using (var c = new MySqlConnection(cb.ConnectionString))
            {
                ...
                var cmd = new MySqlCommand(commandText, c);
        ...
        public override DataTable GetSchema(string collectionName, string[] restrictionValues)
        {
            ...
            var restrictions = schemaProvider.CleanRestrictions(restrictionValues);
            var dt = schemaProvider.GetSchema(collectionName, restrictions);
            return dt;
        }
