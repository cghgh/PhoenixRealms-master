...
namespace db
{
    public partial class Database : IDisposable
    {
        ...
        public Database()
        {
            ...
            _con = Testing
                ? new MySqlConnection(
                    "Server=23.229.68.12;Database=rotmg;uid=root;password=GGnoRE;Pooling=true;Connection Timeout=30;MinimumPoolSize=10;maximumpoolsize=1200;")
                : new MySqlConnection(
                    "Server=127.0.0.1;Database=rotmg;uid=root;password=GGnoRE;Pooling=true;Connection Timeout=30;MinimumPoolSize=10;maximumpoolsize=1200;");
            _con.Open();
        }
