            ...
            : base((short) psr.Character.ObjectType, psr.Random)
        {
            ...
            switch (psr.Account.Rank)
            {
                case 0:
                    ...
                    break;
                case 1:
                    Name = "[Donator] " + psr.Account.Name;
                    break;
                case 2:
                    Name = "[QA] " + psr.Account.Name;
                    break;
                case 3:
                    Name = "[Mod] " + psr.Account.Name;
                    break;
                case 4:
                    Name = "[Dev] " + psr.Account.Name;
                    break;
                case 5:
                    Name = "[HMod] " + psr.Account.Name;
                    break;
                case 6:
                    Name = "[HDDev] " + psr.Account.Name;
                    break;
                case 7:
                    Name = "[HCDev] " + psr.Account.Name;
                    break;
                case 8:
